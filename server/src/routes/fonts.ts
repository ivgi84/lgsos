...
import { FontsController } from '../controllers/fonts';
...
class AuthRouter {
    ...
    setRoutes() {
        this.router.get('/local', (req, res) => {
            this.fontsController.getLocal(req, res);
        });
        this.router.get('/gFonts', (req, res) => {
            this.fontsController.getGFonts(req, res);
        });
    }
}
